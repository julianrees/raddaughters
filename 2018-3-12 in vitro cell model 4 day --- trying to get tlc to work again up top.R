...
#For TLC calc - need to also make out into a data frame after first plot, and name the columns approritately for these state values to work.
#state = c(A = 0, B = plotout[plotout$time==0.083,"Fr-221"], C = plotout[plotout$time==0.083,"At-217"], D = plotout[plotout$time==0.083,"Bi-213"], E = plotout[plotout$time==0.083,"Po-213"], f = plotout[plotout$time==0.083,"Pb-209"], G = plotout[plotout$time==0.083,"Bi-209"], H = plotout[plotout$time==0.083,"Rn-217"], I = plotout[plotout$time==0.083,"Tl-209"],J = nmoleslu177, K = 0, L = nmolesac227, M = nmolesth227, N = nmolesfr223, O = nmolesra223, P = nmolesrn219, Q = nmolespo215, R = nmolespb211, S = nmolesbi211, t = nmolestl207, U = nmolespb207)
